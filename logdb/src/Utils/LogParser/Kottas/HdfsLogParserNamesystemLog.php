...
class HdfsLogParserNamesystemLog extends HdfsLogParser
{
     ...
     *
     * Anything else is considered bad record
     */
    private function format_hdfs_Namesystem_log_line($line, $type)
    {
    ...
    private function format_hdfs_Namesystem_line($line, $type)
    {
